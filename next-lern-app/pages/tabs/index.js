...
const tabs = [
    { id: 0, name: 'Home', current: false },
    { id: 1, name: 'Products', current: false },
    { id: 2, name: 'Services', current: false },
    { id: 3, name: 'Doctors', current: false },
]
...
export default function TabsHome() {
    ...
    return (
        <div>
            ...
            {
                index == 1 ? <Products /> : null
            }
            {
                index == 2 ? <Services /> : null
            }
            {
                index == 3 ? <Doctors /> : null
            }
        </div>
    )
}
